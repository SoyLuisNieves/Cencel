...
?><?php require_once('inicio_session.php'); ?>
    ...
    <section class="content">
        ...
        <div class="seccion"><h3>.: Selección de Producto :.</h3></div><br>
                    ...
                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                        <thead align="center">
                            <tr>                            
                                ...
                                <th >IMEI</th>
                                <th >ICCID/SERIE</th>
                               <th ><div align="center"><form action="aprobar_pedido.php" method="POST"><button name="folio" class="boton" value="<?php echo $_POST['folio']; ?>"><img src="../../images/img/car.png" width="40px"></button></form></div></th>             
                            </tr>
                        </thead>
                    <tbody>
                        <?php  $productos = $Pedidos->get_productos_series();
                        ...
                        <tr class="" align="center">
                            ...
                            <?php if ($row['tipo']==1) { ?>
                                ...
                                <?php if(!empty($_SESSION['aprobar'])){
                                    for ($i=0; $i < count($_SESSION['aprobar']); $i++) { 
                                        if($_SESSION['aprobar'][$i]==$row['iccid']){
                            ...
                            <?php }elseif ($row['tipo']==2) { ?>
                                ...
                                <?php if(!empty($_SESSION['aprobar'])){
                                    for ($i=0; $i < count($_SESSION['aprobar']); $i++) { 
                                        if($_SESSION['aprobar'][$i]==$row['imei']){
                                            echo 'checked="checked"';
                                        }
                                    }
                                } ?>>
            ...
            <!-- #END# Basic Validation -->
             <?php require_once('arrayaprobar.php'); ?>
            ...
            <script type="text/javascript">
                ...
                for ($i = 0; $i < count($_SESSION['aprobar']); $i++) {
                    ...
                    echo 'pedido.push("'.$_SESSION['aprobar'][$i].'");';
                }
                ?>
                ...
                function valuecheck(check)
                {
                    ...
                    $('#resultado').load("arrayaprobar.php",{cleanpedido});
