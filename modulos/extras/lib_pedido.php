            ...
            <div class="" align="right">
                ...
                <div  id="enlaces">
                    <div class="info-box-3 bg-teal hover-zoom-effect">
                        ...
                        <div class="bton">
                            <div class="text">Lista Precios</div>
                        </div>
                    </div>
                </div></a>
                <a >
                <div  id="enlaces">
                    <div class="info-box-3 bg-teal hover-zoom-effect">
                        ...
                        <div class="bton">
                            <div class="text">Descargar Claves</div>
                        </div>
                    </div>
                </div></a>
            </div>
                                    ...
                                    <div class="col-md-12" align="center">
                                        <div class="col-md-5">
                                            <div class="form-group form-float">
                                                <label class="form-label">Folio</label><br>
                                                <div class="ui input mini">
                                                    <input placeholder="Folio pedido" size="20px" type="text" required style="size: 16px;">
                                                </div>
                                            </div>
                                        </div><br>
                                        <button class=" ui submit button Green btn" type="submit" onclick="mostrar()">BUSCAR</button>
                                    		<div class="ui submit button red">CANCELAR</div>
                                    </div>
                                </div>                                
                            </div><br>
                        </div>
