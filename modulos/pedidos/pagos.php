    ...
    <section class="content">
            <div class="block row clearfix">               
             ...
             <?php if (isset($_POST['act_pagos'])) { 
                $pagos = $Pedidos->udp_pagos();
                $pagos = $Pedidos->pagos_sum();
                    $row1 = mysqli_fetch_array($pagos);
                    $importe = $Pedidos->importe();
                    $row2 = mysqli_fetch_array($importe);
                    if ($row1['pago']==$row2['importe']) {
                        $pagado = $Pedidos->importe_pago();
                    }else{
                        $pagado = $Pedidos->importe_p();
                    }
                }
                if (isset($_POST['new_pago'])) { 
                $pagos = $Pedidos->new_pago();
                $pagos = $Pedidos->pagos_sum();
                    $row1 = mysqli_fetch_array($pagos);
                    $importe = $Pedidos->importe();
                    $row2 = mysqli_fetch_array($importe);
            ...
            <form class="ui form" id="form_validation" method="POST">
                    <div class="ui " style="display: ;"> <br>
                        ...
                        <div class="borde esp">
                            <div class="fields">
                                <?php $pagos = $Pedidos->get_pagos_folio();
        ...
        <div id="nuevo_pago" style="display: none;">
            ...
            <form class="ui form" id="form_validation" method="POST">
                ...
                <!--=============================================================-->
                <div class="seccion"><h3>.: Detalles de Pedidos <b>- Pagos Realizados :.</b></h3></div>
                <div class="ui">
