...
?> </section>
    ...
    <?php if (isset($_POST['aprobar'])) {
        //$pedidos = $Pedidos->udp_pedido_cant();

           print "<script>alert(\" PEDIDO APROBADO.\");window.location='aprobar.php';</script>";
        }
        if (isset($_POST['aprobar_cantidades'])) {
           print "<script>alert(\" APROBAR SERIES.\");</script>";
        }
    ?>
<!--===================================SECCIÓN PEDIDOS CANTIDADES (APROBAR)======================================-->

        <?php $pedidos = $Pedidos->get_productos_cantidades();
